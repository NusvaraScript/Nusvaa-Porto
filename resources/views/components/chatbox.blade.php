<section class="border-t border-white/10 py-12 px-2">
    <div class="flex flex-col gap-10">

        {{-- Header --}}
        <div class="text-center">
            <h2 class="text-3xl sm:text-4xl font-bold text-white mb-3">Ask Me Anything</h2>
        ...
        {{-- Chat Card --}}
        <div class="bg-black border border-white/10 rounded-2xl overflow-hidden flex flex-col shadow-2xl">
            ...
            <div id="suggestions-bar" class="hidden px-5 pb-3 pt-3 flex gap-2 flex-wrap border-t border-gray-800"></div>
            ...
            <div class="px-5 py-4 border-t border-white/10 bg-black">
                ...
                <p class="text-center text-gray-600 text-xs mt-2 tracking-wide">Enter to send · Shift+Enter for new line
                </p>
            </div>
...
<script>
    (function () {
        // ── Config ───────────────────────────────────────────────
        // GANTI dengan route proxy Laravel kamu, jangan expose API key di sini!
        // Contoh: '/api/chat'
        ...
        function renderSuggestions(container) {
            ...
            SUGGESTIONS.forEach(s => {
                ...
                btn.textContent = s;
                btn.className = 'text-xs text-black bg-white hover:bg-gray-300 border border-black px-3 py-1.5 rounded-xl transition-all';
