...
<div class="text-white py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <x-section image="images/175510726.jpg" section="More About Me" title="Who am i? Really."
            description="I am a web developer, i dont know what else to say about me at the moment.">
        </x-section>
        ...
        <x-section section="About This Website" title="This Website is My Personal Space on The Internet"
            description="This website is my own little personal space on the internet. I will try to expand this website based on anything I liked, or when I am trying something new."
