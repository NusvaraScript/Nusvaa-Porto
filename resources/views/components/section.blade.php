...
<section class="{{ $border ? 'border-t border-white/10' : '' }} py-12 reveal">
    <div
        class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 {{ $image ? 'grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch' : '' }}">
