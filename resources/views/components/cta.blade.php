<section class="border-t border-white/10 reveal py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
            <div class="md:mr-4">
                ...
                <p class="text-sm my-4 text-gray-300 leading-relaxed">I'm open to freelance projects, collaborations, or
                    just
